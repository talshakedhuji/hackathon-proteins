...
def present_summary_figs(results, seq_len_distribution, output_directory, sequence):
    ...
    :return:
    """
    print(colored("Presenting figures...", 'green'))
...
def run(model_path'./TrainedNanoNet', fasta_file_path='./SolvedNbs/Nb34/Nb34.fa', num_of_mutations=1000):
    ...
    print(colored("PDB of original sequence was created successfully, file name: original.pdb", 'green'))
    all_results = []
...
if __name__ == "__main__":
    ...
    parser.add_argument("fasta", help="Nb fasta file path", default='./SolvedNbs/Nb34/Nb34.fa')
    parser.add_argument("network", help="nanonet trained model path", default='./TrainedNanoNet')
    parser.add_argument("num_of_mutations", help="# of mutations, default is set to 1000", default=1000)
